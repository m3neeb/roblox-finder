...
st.write("Finds 20 games with 200–2k concurrent players and 750–90k total visits.")
        ...
        try:
            ...
            if response.status_code != 200:
                ...
                for place_id, details in games_dict.items():
                    title = details[0]
                    active_players = details[1]
                    visits = details[2]
                    
                    if (200 <= active_players <= 2000) and (750 <= visits <= 90000):
                ...
                if not matched_games:
                    st.warning("No games matched your specific thresholds right now. Try again later!")
                else:
                    ...
                    for idx, game in enumerate(matched_games, 1):
                        ...
                        # Create two columns: left for thumbnail, right for info
